...
def getListOfNeighbours(i, j, allNumbers, numOfNeighbours):
    ...
    appendWith(lambda index: [i         , j + index], allNeighbours, allNumbers, numOfNeighbours)  # horizontal
    appendWith(lambda index: [i + index , j        ], allNeighbours, allNumbers, numOfNeighbours)  # vertical
    appendWith(lambda index: [i + index , j + index], allNeighbours, allNumbers, numOfNeighbours)  # top-right
    appendWith(lambda index: [i + index , j - index], allNeighbours, allNumbers, numOfNeighbours)  # top-left
...
def testHighestOnHorizontal():
    nums = [[8 , 2 , 22, 97],
            [49, 49, 0, 40],
            [81, 49, 31, 0],
            [52, 70, 95, 23],
            [10, 70, 0 , 5]]
    assert 70 * 95 == findHighestProd(nums, 2)

def testHighestOnVertical():
    nums = [[8 , 2 , 22, 0],
            [49, 49, 99, 40],
            [81, 49, 31, 73],
            [52, 70, 95, 23],
            [10, 70, 99, 5]]
    assert 95 * 99 == findHighestProd(nums, 2)

def testHighestOnDiagonal():
    nums = [[8 , 2 , 22, 97],
            [49, 49, 99, 40],
            [81, 49, 31, 73],
            [99, 70, 95, 23],
            [0 , 99, 0 , 0]]
    assert 99 * 99 == findHighestProd(nums, 2)
...
def testWith3Nums():
    nums = [[8 , 2 , 22, 97],
            ...
            [99, 70, 95, 23],
            [0 , 0 , 0 , 0]]
    assert 99 * 70 * 95 == findHighestProd(nums, 3)
